...
class Zend_Gdata_Gapps_UserFeedTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testEmptyFeedShouldHaveNoExtensionElements()
    {
        ...
        $this->assertTrue(0 == count($this->emptyUserFeed->extensionElements));
    }
