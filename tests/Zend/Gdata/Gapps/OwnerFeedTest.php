...
class Zend_Gdata_Gapps_OwnerFeedTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testEmptyFeedShouldHaveNoExtensionElements()
    {
        ...
        $this->assertTrue(0 == count($this->emptyOwnerFeed->extensionElements));
    }
