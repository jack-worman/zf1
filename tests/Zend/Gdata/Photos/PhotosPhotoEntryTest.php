...
class Zend_Gdata_Photos_PhotosPhotoEntryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testExifData()
    {
        ...
        $this->assertTrue(null != $exifTags);
        $this->assertTrue(null != $exifTags->flash);
        $this->assertTrue(null != $exifTags->fstop);
        $this->assertTrue(null != $exifTags->exposure);
        $this->assertTrue(null != $exifTags->focallength);
        $this->assertTrue(null != $exifTags->iso);
        $this->assertTrue(null != $exifTags->time);
        $this->assertTrue(null != $exifTags->distance);
        $this->assertTrue(null != $exifTags->make);
        $this->assertTrue(null != $exifTags->model);
        $this->assertTrue(null != $exifTags->imageUniqueID);
