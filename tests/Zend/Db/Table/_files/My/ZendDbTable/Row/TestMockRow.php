...
class My_ZendDbTable_Row_TestMockRow extends Zend_Db_Table_Row_Abstract
{
    ...
    public function findDependentRowset($dependentTable, $ruleKey = null, Zend_Db_Table_Select|null $select = null)
    {
        $this->dependentTable    = $dependentTable;
        $this->ruleKey           = $ruleKey;
    }

    public function findParentRow($parentTable, $ruleKey = null, Zend_Db_Table_Select|null $select = null)
    {
    ...
    public function findManyToManyRowset($matchTable, $intersectionTable, $callerRefRule = null,
                                         $matchRefRule = null, Zend_Db_Table_Select|null $select = null)
    {
