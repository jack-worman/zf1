...
class Zend_Crypt_HmacTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testHmacRIPEMD1601()
    {
        $data = 'Hi There';
        $key = str_repeat("\x0b", 20);
    ...
    public function testHmacRIPEMD1602()
    {
        $data = 'what do ya want for nothing?';
        $key = 'Jefe';
        $hmac = Zend_Crypt_Hmac::compute($key, 'RIPEMD160', $data);
    ...
    public function testHmacRIPEMD1603()
    {
        $data = str_repeat("\xdd", 50);
        $key = str_repeat("\xaa", 20);
        $hmac = Zend_Crypt_Hmac::compute($key, 'RIPEMD160', $data);
    ...
    public function testHmacRIPEMD1604()
    {
        $data = str_repeat("\xcd", 50);
        $key = "\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19";
        $hmac = Zend_Crypt_Hmac::compute($key, 'RIPEMD160', $data);
    ...
    public function testHmacRIPEMD1605()
    {
        $data = 'Test With Truncation';
        $key = str_repeat("\x0c", 20);
        $hmac = Zend_Crypt_Hmac::compute($key, 'RIPEMD160', $data);
    ...
    public function testHmacRIPEMD1606()
    {
        $data = 'Test Using Larger Than Block-Size Key - Hash Key First';
        $key = str_repeat("\xaa", 80);
        $hmac = Zend_Crypt_Hmac::compute($key, 'RIPEMD160', $data);
    ...
    public function testHmacRIPEMD1607()
    {
        $data = 'Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data';
        $key = str_repeat("\xaa", 80);
        $hmac = Zend_Crypt_Hmac::compute($key, 'RIPEMD160', $data);
