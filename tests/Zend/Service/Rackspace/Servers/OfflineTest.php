...
class Zend_Service_Rackspace_Servers_OfflineTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreateSharedIpGroup()
    {
        ...
        $this->assertTrue(false !== self::$sharedIpGroup);
