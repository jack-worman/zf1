...
class Zend_Mail_MessageTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testToplines()
    {
        ...
        $this->assertTrue(0 === strpos((string) $message->getToplines(), 'multipart message'));
    }
    ...
    public function testEmptyBody()
    {
        ...
        $message = new Zend_Mail_Message([]);
        $this->assertTrue(0 == $message->countParts());
    }
    ...
    public function testLateFetch()
    {
        ...
        $message = new Zend_Mail_Message(['handler' => $mail, 'id' => 5]);
        $this->assertTrue(0 === strpos((string) $message->getContent(), 'multipart message'));
    }
