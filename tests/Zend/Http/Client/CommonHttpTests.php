...
abstract class Zend_Http_Client_CommonHttpTests extends \PHPUnit\Framework\TestCase
{
    ...
    public function testHeadersSingle()
    {
        ...
        foreach ($headers as $key => $val)
            $this->assertStringContainsString(strtolower((string) "$key: $val"), $body);

        $this->assertStringContainsString(strtolower((string) $acceptHeader), $body);
    }
    ...
    public function testHeadersArray()
    {
        ...
        foreach ($headers as $key => $val) {
            if (is_string($key)) {
                ...
                $this->assertStringContainsString(strtolower((string) $val), $body);
            }
        }
     }
