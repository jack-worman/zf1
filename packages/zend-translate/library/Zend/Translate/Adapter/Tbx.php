...
class Zend_Translate_Adapter_Tbx extends Zend_Translate_Adapter
{
        ...
        if (null !== $this->_term) {
            ...
            switch (strtolower((string) $name)) {
                case 'termentry':
                    ...
                    break;
                case 'langset':
                    if (true === isset($attrib['xml:lang'])) {
                        $this->_langset = $attrib['xml:lang'];
                        if (false === isset($this->_data[$this->_langset])) {
    ...
    {
        if ((null !== $this->_term) and ('term' != $name)) {
            $this->_content .= '</'.$name.'>';
        } else {
            switch (strtolower((string) $name)) {
                case 'langset':
                ...
                case 'term':
                    ...
                    if (!empty($this->_content) or (false === isset($this->_data[$this->_langset][$this->_termentry]))) {
