...
class Zend_Cache_Backend_Test extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    ...
    public function load($id, $doNotTestCacheValidity = false)
    {
        ...
        if ('false' == $id
          || 'd8523b3ee441006261eeffa5c3d3a0a7' == $id
          || 'e83249ea22178277d5befc2c5e2e9ace' == $id
          || '40f649b94977c0a6e76902e2a0b43587' == $id
          || '88161989b73a4cbfd0b701c446115a99' == $id
          || '205fc79cba24f0f0018eb92c7c8b3ba4' == $id
          || '170720e35f38150b811f68a937fb042d' == $id) {
            return false;
        }
        if ('serialized' == $id) {
        ...
        if ('71769f39054f75894288e397df04e445' == $id || '615d222619fb20b527168340cebd0578' == $id
          || '8a02d218a5165c467e7a5747cc6bd4b6' == $id || '648aca1366211d17cbf48e65dc570bee' == $id
          || '4a923ef02d7f997ca14d56dfeae25ea7' == $id) {
            return serialize(['foo', 'bar']);
        }
        if ('f53c7d912cc523d9a65834c8286eceb9' == $id) {
    ...
    public function test($id)
    {
        ...
        if ('3c439c922209e2cb0b54d6deffccd75a' == $id) {
            return false;
        }
