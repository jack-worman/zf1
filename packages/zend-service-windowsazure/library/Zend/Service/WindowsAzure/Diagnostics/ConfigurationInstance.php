...
class Zend_Service_WindowsAzure_Diagnostics_ConfigurationInstance extends Zend_Service_WindowsAzure_Diagnostics_ConfigurationObjectBaseAbstract
{
    ...
    public function toXml()
    {
        ...
        if (0 == count($this->DataSources->PerformanceCounters->Subscriptions)) {
        ...
        if (0 == count($this->DataSources->WindowsEventLog->Subscriptions)) {
            $returnValue[] = '      <Subscriptions />';
        } else {
            $returnValue[] = '      <Subscriptions>';
        ...
        if (0 == count($this->DataSources->Directories->Subscriptions)) {
            $returnValue[] = '      <Subscriptions />';
        } else {
            $returnValue[] = '      <Subscriptions>';
