...
class Zend_Gdata_Kind_EventEntry extends Zend_Gdata_Entry
{
    ...
    public function getDOM($doc = null, $majorVersion = 1, $minorVersion = null)
    {
        ...
        if (null != $this->_recurrenceException) {
        ...
        if (null != $this->_extendedProperty) {
