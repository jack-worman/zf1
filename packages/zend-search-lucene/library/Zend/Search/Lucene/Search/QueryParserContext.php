...
class Zend_Search_Lucene_Search_QueryParserContext
{
    ...
    {
        return (null !== $this->_nextEntryField) ? $this->_nextEntryField : $this->_defaultField;
    }
    ...
    public function setNextEntrySign($sign)
    {
        ...
        if (Zend_Search_Lucene_Search_QueryToken::TT_REQUIRED == $sign) {
            $this->_nextEntrySign = true;
        } elseif (Zend_Search_Lucene_Search_QueryToken::TT_PROHIBITED == $sign) {
    ...
    public function processFuzzyProximityModifier($parameter = null)
    {
        ...
        if (null !== $this->_nextEntryField || null !== $this->_nextEntrySign) {
            // require_once 'Zend/Search/Lucene/Search/QueryParserException.php';
    ...
    public function _signStyleExpressionQuery()
    {
        ...
        foreach ($this->_entries as $entryId => $entry) {
            $sign = (null !== $this->_signs[$entryId]) ? $this->_signs[$entryId] : $defaultSign;
