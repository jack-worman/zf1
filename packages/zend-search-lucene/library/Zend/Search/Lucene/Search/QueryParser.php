...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        try {
            ...
            self::$_instance->_encoding = (null !== $encoding) ? $encoding : self::$_instance->_defaultEncoding;
            ...
            // Empty query
            if (0 == count(self::$_instance->_tokens)) {
            ...
            foreach (self::$_instance->_tokens as $token) {
                try {
                    ...
                    if (false !== strpos((string) $e->getMessage(), 'There is no any rule for')) {
            ...
            if (0 != count(self::$_instance->_contextStack)) {
            ...
            if (self::$_instance->_suppressQueryParsingExceptions) {
                ...
                $termsSign = (self::B_AND == self::$_instance->_defaultOperator) ? true /* required term */ :
                                                                                   null /* optional term */;
