...
abstract class Zend_Pdf_FileParser
{
    ...
    public function readInt($size, $byteOrder = Zend_Pdf_FileParser::BYTE_ORDER_BIG_ENDIAN)
    {
         ...
         */
        if (Zend_Pdf_FileParser::BYTE_ORDER_BIG_ENDIAN == $byteOrder) {
        ...
        } elseif (Zend_Pdf_FileParser::BYTE_ORDER_LITTLE_ENDIAN == $byteOrder) {
        ...
        $characterSet = '')
    {
        ...
        if (Zend_Pdf_FileParser::BYTE_ORDER_BIG_ENDIAN == $byteOrder) {
            if ('UTF-16BE' == $characterSet) {
                return $bytes;
            }

            return iconv('UTF-16BE', $characterSet, $bytes);
        } elseif (Zend_Pdf_FileParser::BYTE_ORDER_LITTLE_ENDIAN == $byteOrder) {
            if ('UTF-16LE' == $characterSet) {
                return $bytes;
            }
