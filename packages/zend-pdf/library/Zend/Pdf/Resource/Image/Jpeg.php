...
class Zend_Pdf_Resource_Image_Jpeg extends Zend_Pdf_Resource_Image
{
    ...
    public function __construct($imageFileName)
    {
        ...
        $gd_options = gd_info();
        if ((!isset($gd_options['JPG Support']) || true != $gd_options['JPG Support'])
             && (!isset($gd_options['JPEG Support']) || true != $gd_options['JPEG Support'])) {
            // require_once 'Zend/Pdf/Exception.php';
        ...
        if (IMAGETYPE_JPEG != $imageInfo[2] && IMAGETYPE_JPEG2000 != $imageInfo[2]) {
            // require_once 'Zend/Pdf/Exception.php';
        ...
        } elseif (IMAGETYPE_JPEG2000 == $imageInfo[2]) {
