...
abstract class Zend_Pdf_FileParser_Font_OpenType extends Zend_Pdf_FileParser_Font
{
    ...
    protected function _parseNameTable()
    {
        ...
        for ($nameIndex = 0; $nameIndex < $nameCount; ++$nameIndex) {
            ...
            if (!(((3 == $platformID) && (1 == $encodingID))    // Microsoft Unicode
                    || ((1 == $platformID) && (0 == $encodingID))       // Mac Roman
            )) {
    ...
    protected function _parsePostTable()
    {
        ...
        $this->isMonospaced = (0 !== $fixedPitch);
    ...
    protected function _parseOs2Table()
    {
        ...
        try {
             ...
             */
            // require_once 'Zend/Pdf/Exception.php';
            if (Zend_Pdf_Exception::REQUIRED_TABLE_NOT_FOUND == $e->getCode()) {
        ...
        $this->isSerifFont = ((($familyClass >= 1) && ($familyClass <= 5))
                                   || (7 == $familyClass));
        $this->isSansSerifFont = (8 == $familyClass);
        $this->isOrnamentalFont = (9 == $familyClass);
        $this->isScriptFont = (10 == $familyClass);
        $this->isSymbolicFont = (12 == $familyClass);
         ...
         */
        $this->isAdobeLatinSubset = ((1 == $unicodeRange1) && (0 == $unicodeRange2)
                                      && (0 == $unicodeRange3) && (0 == $unicodeRange4));
    ...
    protected function _parseCmapTable()
    {
        ...
        for ($subtableIndex = 0; $subtableIndex < $subtableCount; ++$subtableIndex) {
            ...
            if (!(((0 == $platformID) && (3 == $encodingID))    // Unicode 2.0 or later
                    || ((0 == $platformID) && (0 == $encodingID))    // Unicode
                    || ((3 == $platformID) && (1 == $encodingID))    // Microsoft Unicode
                    || ((1 == $platformID) && (0 == $encodingID))       // Mac Roman
            )) {
    ...
    {
        if (3 == $platformID) {    // Microsoft encoding.
        ...
        } elseif (1 == $platformID) {    // Macintosh encoding.
            switch ($languageID) {
                case 0:
                    return 'en';
                case 1:
