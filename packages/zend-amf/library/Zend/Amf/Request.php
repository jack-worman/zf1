...
class Zend_Amf_Request
{
    ...
    public function readMessage(Zend_Amf_Parse_InputStream $stream)
    {
        ...
        if ((Zend_Amf_Constants::AMF0_OBJECT_ENCODING != $clientVersion)
            && (Zend_Amf_Constants::AMF3_OBJECT_ENCODING != $clientVersion)
            && (Zend_Amf_Constants::FMS_OBJECT_ENCODING != $clientVersion)
        ) {
    ...
    public function readBody()
    {
        ...
        if (Zend_Amf_Constants::AMF3_OBJECT_ENCODING == $this->_deserializer->getObjectEncoding()) {
            /*
