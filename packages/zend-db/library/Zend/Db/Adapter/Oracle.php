...
class Zend_Db_Adapter_Oracle extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        $connectionFuncName = (true == $this->_config['persistent']) ? 'oci_pconnect' : 'oci_connect';
    ...
    public function isConnected()
    {
        return (bool) (is_resource($this->_connection)
                    && ('oci8 connection' == get_resource_type($this->_connection)
                     || 'oci8 persistent connection' == get_resource_type($this->_connection)));
    }
