...
abstract class Zend_Db_Adapter_Abstract
{
    ...
    public function quote($value, $type = null)
    {
        ...
        if (null !== $type && array_key_exists($type = strtoupper((string) $type), $this->_numericDataTypes)) {
            $quotedValue = '0';
    ...
    {
        if (false === $auto || true === $this->_autoQuoteIdentifiers) {
    ...
    {
        if (false == $this->_allowSerialization) {
            /* @see Zend_Db_Adapter_Exception */
            // require_once 'Zend/Db/Adapter/Exception.php';
    ...
    {
        if (true == $this->_autoReconnectOnUnserialize) {
            $this->getConnection();
        }
    }
