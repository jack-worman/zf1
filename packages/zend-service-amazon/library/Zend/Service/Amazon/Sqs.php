...
class Zend_Service_Amazon_Sqs extends Zend_Service_Amazon_Abstract
{
    ...
    public function create($queue_name, $timeout = null)
    {
        ...
        $timeout = (null === $timeout) ? self::CREATE_TIMEOUT_DEFAULT : (int) $timeout;
        ...
        do {
            ...
            if (!isset($result->CreateQueueResult->QueueUrl)
                ...
                if ('AWS.SimpleQueueService.QueueNameExists' == $result->Error->Code) {
                    return false;
                } elseif ('AWS.SimpleQueueService.QueueDeletedRecently' == $result->Error->Code) {
