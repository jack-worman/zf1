...
class Zend_Service_Amazon_Ec2_Instance extends Zend_Service_Amazon_Ec2_Abstract
{
    ...
    public function run(array $options)
    {
        ...
        if (isset($options['monitor']) && true === $options['monitor']) {
    ...
    public function describe($instanceId = null, $ignoreTerminated = false)
    {
        ...
        foreach ($nodes as $node) {
            if (48 == $xpath->evaluate('string(ec2:instancesSet/ec2:item/ec2:instanceState/ec2:code/text())', $node) && $ignoreTerminated) {
                continue;
            }
            $item = [];
