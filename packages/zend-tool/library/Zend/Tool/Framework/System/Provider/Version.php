...
class Zend_Tool_Framework_System_Provider_Version implements Zend_Tool_Framework_Provider_Interface, Zend_Tool_Framework_Registry_EnabledInterface
{
    ...
    public function showMajorPart($nameIncluded = true)
    {
        ...
        $output = ((true == $nameIncluded) ? 'ZF Major Version: ' : null).$versionNumbers['major'];
        $this->_registry->response->appendContent($output);
    }
    ...
    {
        $versionNumbers = $this->_splitVersion();
        $output = ((true == $nameIncluded) ? 'ZF Minor Version: ' : null).$versionNumbers['minor'];
        $this->_registry->response->appendContent($output);
    }
    ...
    {
        $versionNumbers = $this->_splitVersion();
        $output = ((true == $nameIncluded) ? 'ZF Mini Version: ' : null).$versionNumbers['mini'];
        $this->_registry->response->appendContent($output);
    }
