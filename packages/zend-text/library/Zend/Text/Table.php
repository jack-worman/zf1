...
class Zend_Text_Table
{
    ...
    public function __construct($options = null)
    {
        ...
        if (null === $this->_decorator) {
            if ('utf-8' === self::getOutputCharset()) {
        ...
        foreach ($this->_rows as $rowNum => $row) {
            ...
            if (0 === $rowNum) {
                ...
                if ($this->_autoSeparate & self::AUTO_SEPARATE_ALL) {
                    $drawSeparator = true;
                } elseif (1 === $rowNum && $this->_autoSeparate & self::AUTO_SEPARATE_HEADER) {
                    $drawSeparator = true;
